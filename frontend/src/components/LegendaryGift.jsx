export default function LegendaryGift({ id, type, sender }) {
  const giftId = type || id || 'bermuda-triangle'
  return (
    <div className="stage">
      <div className="gift-3d"><img src={`/gifts/${giftId}.png`} alt={giftId} /><div className="glow"></div></div>
      <div className="tag">{sender || 'Someone'} sent {giftId} on NVME!</div>
      <style jsx>{`
